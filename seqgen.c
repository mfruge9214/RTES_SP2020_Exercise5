...
struct timeval launch_time_val;
struct timeval launch1_time_val;
struct timeval launch2_time_val;
struct timeval launch3_time_val;
struct timeval launch4_time_val;
struct timeval launch5_time_val;
struct timeval launch6_time_val;
struct timeval launch7_time_val;


struct timeval common_time_val;
struct timeval seqgen_time_val;
...
void main(void)
{
    ...
    syslog(LOG_CRIT, "mmSequencer @ usec=%ld, msec=%d\n", (long)(current_time_val.tv_usec- start_time_val.tv_usec), (int)current_time_val.tv_usec/USEC_PER_MSEC);
   ...
   printf("Using CPUS=%d from total available.\n", CPU_COUNT(&allcpuset));
    ...
    threadParams[0].sequencePeriods=940;
...
{
    //struct timeval current_time_val;
    struct timespec delay_time = {0,333333}; // delay for 333.33 usec, 3 kHz (1e-9 x 333,333)
    struct timespec remaining_time;
    double current_time;
    double residual;
    //double initial, final;//fine_Time// DELETE
    ...
    gettimeofday(&common_time_val, (struct timezone *)0);
    syslog(LOG_CRIT, "--Sequencer thread @ usec=%ld, msec=%d, usec=%ld\n", (long)(common_time_val.tv_usec- start_time_val.tv_usec), 
								(int)common_time_val.tv_usec/USEC_PER_MSEC, (long)common_time_val.tv_usec);
    ...
    do
    {
        ...
        gettimeofday(&seqgen_time_val, (struct timezone *)0);
        //initial= current_time_val.tv_usec;//fine_Time// DELETE
        syslog(LOG_CRIT, "ll0Sequencer thread prior to delay @ usec=%ld, msec=%d, usec=%ld\n", (long)(seqgen_time_val.tv_usec- common_time_val.tv_usec), 
								(int)seqgen_time_val.tv_usec/USEC_PER_MSEC, (long)(seqgen_time_val.tv_usec));
        do
        {
        ...
        seqCnt++;
        gettimeofday(&current_time_val, (struct timezone *)0);
        //final= current_time_val.tv_usec;//fine_Time//DELETE
        syslog(LOG_CRIT, "ee0Sequencer cycle %llu @ usec_base=%ld, msec=%d, usec=%ld, duration_us=%ld\n", seqCnt, (long)(current_time_val.tv_usec- common_time_val.tv_usec), 
					(int)current_time_val.tv_usec/USEC_PER_MSEC, (long)(current_time_val.tv_usec), (long)(current_time_val.tv_usec- seqgen_time_val.tv_usec));
        //syslog(LOG_CRIT, "Delta usec=%f\n", final- initial); //DELETE
	...
	gettimeofday(&launch1_time_val, (struct timezone *)0);//get time
	syslog(LOG_CRIT, "ll1 usec=%ld\n", launch1_time_val.tv_usec);//get time
	}

        // Service_2 = RT_MAX-2 @ 1 Hz
        if((seqCnt % 30) == 0) {sem_post(&semS2);
	gettimeofday(&launch2_time_val, (struct timezone *)0);
	syslog(LOG_CRIT, "ll2 usec=%ld\n", launch2_time_val.tv_usec);
	}

        // Service_3 = RT_MAX-3 @ 0.5 Hz
        if((seqCnt % 60) == 0) {sem_post(&semS3);
	gettimeofday(&launch3_time_val, (struct timezone *)0);
	syslog(LOG_CRIT, "ll3 usec=%ld\n", launch3_time_val.tv_usec);
	}

        // Service_4 = RT_MAX-2 @ 1 Hz
        if((seqCnt % 30) == 0) {sem_post(&semS4);
	gettimeofday(&launch4_time_val, (struct timezone *)0);
	syslog(LOG_CRIT, "ll4 usec=%ld\n", launch4_time_val.tv_usec);
	}

        // Service_5 = RT_MAX-3 @ 0.5 Hz
        if((seqCnt % 60) == 0) {sem_post(&semS5);
	gettimeofday(&launch5_time_val, (struct timezone *)0);
	syslog(LOG_CRIT, "ll5 usec=%ld\n", launch5_time_val.tv_usec);
	}

        // Service_6 = RT_MAX-2 @ 1 Hz
        if((seqCnt % 30) == 0) {sem_post(&semS6);
	gettimeofday(&launch6_time_val, (struct timezone *)0);
	syslog(LOG_CRIT, "ll6 usec=%ld\n", launch6_time_val.tv_usec);
	}

        // Service_7 = RT_MIN   0.1 Hz
        if((seqCnt % 300) == 0) {sem_post(&semS7);
	gettimeofday(&launch7_time_val, (struct timezone *)0);
	syslog(LOG_CRIT, "ll7 usec=%ld\n", launch7_time_val.tv_usec);
	}
...
void *Service_1(void *threadp)
{
    ...
    gettimeofday(&current_time_val, (struct timezone *)0);
    syslog(LOG_CRIT, "!1Frame Sampler thread @ sec=%d, msec=%d\n", (int)(current_time_val.tv_sec-start_time_val.tv_sec), (int)current_time_val.tv_usec/USEC_PER_MSEC);
    ...
    while(!abortS1)
    {
        ...
        S1Cnt++;
        gettimeofday(&current_time_val, (struct timezone *)0);
        syslog(LOG_CRIT, "ee1Frame Sampler release %llu @ sec=%d, delta_us=%ld, usec=%d, duration_us=%ld\n", S1Cnt, (int)(current_time_val.tv_sec-start_time_val.tv_sec), 
								(long)(current_time_val.tv_usec- common_time_val.tv_usec),
								(int)current_time_val.tv_usec, (long)(current_time_val.tv_usec- launch1_time_val.tv_usec));//get time
    }
...
void *Service_2(void *threadp)
{
    ...
    gettimeofday(&current_time_val, (struct timezone *)0);
    syslog(LOG_CRIT, "@2Time-stamp with Image Analysis thread @ sec=%d, msec=%d\n", (int)(current_time_val.tv_sec-start_time_val.tv_sec), (int)current_time_val.tv_usec/USEC_PER_MSEC);
    ...
    while(!abortS2)
    {
        ...
        gettimeofday(&current_time_val, (struct timezone *)0);
        syslog(LOG_CRIT, "ee2Time-stamp with Image Analysis release %llu @ sec=%d, delta_us=%ld, usec=%d, duration_us=%ld\n", S2Cnt, (int)(current_time_val.tv_sec-start_time_val.tv_sec), 
								(long)(current_time_val.tv_usec- common_time_val.tv_usec),
								(int)current_time_val.tv_usec, (long)(current_time_val.tv_usec- launch2_time_val.tv_usec));//get time
    }
...
void *Service_3(void *threadp)
{
    ...
    gettimeofday(&current_time_val, (struct timezone *)0);
    syslog(LOG_CRIT, "#3Difference Image Proc thread @ sec=%d, msec=%d\n", (int)(current_time_val.tv_sec-start_time_val.tv_sec), (int)current_time_val.tv_usec/USEC_PER_MSEC);
    ...
    while(!abortS3)
    {
        ...
        gettimeofday(&current_time_val, (struct timezone *)0);
        syslog(LOG_CRIT, "ee3Difference Image Proc release %llu @ sec=%d, delta_us=%ld, msec=%d, duration_us=%ld\n", S3Cnt, (int)(current_time_val.tv_sec-start_time_val.tv_sec), 
											(long)(current_time_val.tv_usec- common_time_val.tv_usec),
											(int)current_time_val.tv_usec/USEC_PER_MSEC, (long)(current_time_val.tv_usec- launch3_time_val.tv_usec));
    }
...
void *Service_4(void *threadp)
{
    ...
    gettimeofday(&current_time_val, (struct timezone *)0);
    syslog(LOG_CRIT, "+4Time-stamp Image Save to File thread @ sec=%d, msec=%d\n", (int)(current_time_val.tv_sec-start_time_val.tv_sec), (int)current_time_val.tv_usec/USEC_PER_MSEC);
    ...
    while(!abortS4)
    {
        ...
        gettimeofday(&current_time_val, (struct timezone *)0);
        syslog(LOG_CRIT, "ee4Time-stamp Image Save to File release %llu @ sec=%d, delta_us=%ld, msec=%d, duration_us=%ld\n", S4Cnt, (int)(current_time_val.tv_sec-start_time_val.tv_sec), 
											(long)(current_time_val.tv_usec- common_time_val.tv_usec),
											(int)current_time_val.tv_usec/USEC_PER_MSEC, (long)(current_time_val.tv_usec- launch4_time_val.tv_usec));
    }
...
void *Service_5(void *threadp)
{
    ...
    gettimeofday(&current_time_val, (struct timezone *)0);
    syslog(LOG_CRIT, "*5Processed Image Save to File thread @ sec=%d, msec=%d\n", (int)(current_time_val.tv_sec-start_time_val.tv_sec), (int)current_time_val.tv_usec/USEC_PER_MSEC);
    ...
    while(!abortS5)
    {
        ...
        gettimeofday(&current_time_val, (struct timezone *)0);
        syslog(LOG_CRIT, "ee5Processed Image Save to File release %llu @ sec=%d, delta_us=%ld, msec=%d, duration_us=%ld\n", S5Cnt, (int)(current_time_val.tv_sec-start_time_val.tv_sec),
											(long)(current_time_val.tv_usec- common_time_val.tv_usec), 
											(int)current_time_val.tv_usec/USEC_PER_MSEC, (long)(current_time_val.tv_usec- launch5_time_val.tv_usec));
    }
...
void *Service_6(void *threadp)
{
    ...
    gettimeofday(&current_time_val, (struct timezone *)0);
    syslog(LOG_CRIT, ":6Send Time-stamped Image to Remote thread @ sec=%d, msec=%d\n", (int)(current_time_val.tv_sec-start_time_val.tv_sec), (int)current_time_val.tv_usec/USEC_PER_MSEC);
    ...
    while(!abortS6)
    {
        ...
        gettimeofday(&current_time_val, (struct timezone *)0);
        syslog(LOG_CRIT, "ee6Send Time-stamped Image to Remote release %llu @ sec=%d, delta_us=%ld, msec=%d, duration_us=%ld\n", S6Cnt, (int)(current_time_val.tv_sec-start_time_val.tv_sec), 
											(long)(current_time_val.tv_usec- common_time_val.tv_usec), 
											(int)current_time_val.tv_usec/USEC_PER_MSEC, (long)(current_time_val.tv_usec- launch6_time_val.tv_usec));
    }
...
void *Service_7(void *threadp)
{
    ...
    while(!abortS7)
    {
        ...
        gettimeofday(&current_time_val, (struct timezone *)0);
        syslog(LOG_CRIT, "ee710 Sec Tick Debug release %llu @ sec=%d, delta_us=%ld, msec=%d, duration_us=%ld\n", S7Cnt, (int)(current_time_val.tv_sec-start_time_val.tv_sec), 
											(long)(current_time_val.tv_usec- common_time_val.tv_usec),
											(int)current_time_val.tv_usec/USEC_PER_MSEC, (long)(current_time_val.tv_usec- launch7_time_val.tv_usec));
    }
